...
__printf(3, 4) void scx_ops_exit_kind(s32 exit_code,
...
static void bpf_exit_bstr_common(s32 exit_code, enum scx_exit_kind kind,
				 ...
				 u32 data__sz)
{
	...
	scx_ops_exit_kind(exit_code, kind, "%s", bufs->msg);
out_restore:
 ...
 * @exit_code: Return value to pass to user space via struct scx_exit_info.
 ...
 * disabling.
 */
__bpf_kfunc void scx_bpf_exit_bstr(s32 exit_code, char *fmt,
				   unsigned long long *data, u32 data__sz)
{
	bpf_exit_bstr_common(exit_code, SCX_EXIT_UNREG_BPF, fmt, data,
			     data__sz);
}
				    ...
				    u32 data__sz)
{
	...
	bpf_exit_bstr_common(0, SCX_EXIT_ERROR_BPF, fmt, data,
			     data__sz);
}
