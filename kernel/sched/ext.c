 ...
 *   \-------------------------------/
 *
 * QUEUEING and DISPATCHING states can be waited upon and nests inside rq locks
 * in terms of locking order. Transitions out of them into NONE or QUEUED must
 * store_release and the waiters should load_acquire.
 *
