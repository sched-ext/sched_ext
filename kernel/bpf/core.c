...
const struct bpf_func_proto bpf_get_cgroup_id_proto __weak;
const struct bpf_func_proto bpf_get_cgroup_by_id_proto __weak;
const struct bpf_func_proto bpf_get_ancestor_cgroup_proto __weak;
