...
extern int scx_bpf_cpumask_test_cpu(int cpu, const struct cpumask *cpumask) __ksym;
...
extern int scx_bpf_cpumask_first(const struct cpumask *cpus_allowed) __ksym;
extern bool scx_bpf_has_idle_cpus_among_untyped(unsigned long cpus_allowed) __ksym;
extern void scx_bpf_kick_cpu(int cpu) __ksym;
