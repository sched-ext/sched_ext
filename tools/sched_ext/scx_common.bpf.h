...
extern void scx_bpf_error_bstr(unsigned long unsafe_fmt, unsigned long data, u32 data_len) __ksym;
...
({										\
	...
	_Pragma("GCC diagnostic pop")						\
										\
	scx_bpf_error_bstr((unsigned long)fmt,					\
			   (unsigned long)___param, sizeof(___param));		\
										\
...
extern void scx_bpf_dispatch(struct task_struct *p, u64 dsq_id, u64 enq_flags) __ksym;
